...
Closed syncmers in pure C. Supports arbitrary k values and s < 64 (using `uint128_t`). s-mers are selected according to lexicographic order (no hashing). Achieves around 60 MB/sec throughput.
